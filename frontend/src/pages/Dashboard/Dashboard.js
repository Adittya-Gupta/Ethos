...
function Dashboard(props) {
  ...
  const mydbref = dbref(
    db,
    "users/" + (storedAuth.user ? storedAuth.user.uid : "user")
  );
  ...
  return (
    <div style={{ position: "relative" }}>
      <div>
        <Navbar
          name={storedAuth.user ? storedAuth.user.displayName : "USer"}
          theme={props.theme}
          ...
          {cards.map((card) => {
            return (
              <Card
                ...
                commentsNumber={card.commentsNumber}
